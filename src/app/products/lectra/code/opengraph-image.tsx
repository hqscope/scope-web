    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
          ...
          >
            A POSIX-style shell, on-device Git and GitHub, SSH, and Python — offline, beside your notes.
          </span>
        </div>
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            <span style={{ fontWeight: 700, color: "#c42b26" }}>
              canvascope.org/products/lectra/code
            </span>
            <span style={{ opacity: 0.5 }}>·</span>
            <span style={{ opacity: 0.7 }}>Free on the App Store</span>
          </div>
          <div style={{ display: "flex", gap: "16px" }}>
            <span style={{ fontSize: "20px", opacity: 0.6 }}>Terminal</span>
            <span style={{ fontSize: "20px", opacity: 0.6 }}>·</span>
            <span style={{ fontSize: "20px", opacity: 0.6 }}>Git</span>
            <span style={{ fontSize: "20px", opacity: 0.6 }}>·</span>
            <span style={{ fontSize: "20px", opacity: 0.6 }}>SSH</span>
          </div>
        </div>
      </div>
    ),
