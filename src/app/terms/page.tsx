...
export const metadata: Metadata = {
  title: "Terms of Service | Canvascope",
  description:
    "The terms for using Canvascope, Lectra Notes, and the Canvascope web workspace: accounts, your content, academic integrity, AI features, third-party platforms, and the as-is nature of the product.",
  alternates: {
    canonical: "/terms",
  },
};
...
const highlights = [
  {
    ...
    copy:
      "Canvascope and Lectra are free and still evolving. We work toward stability, but we provide the product as is, without warranties, and you keep your own copies of critical academic files.",
  },
  {
    icon: GraduationCap,
    title: "Academic integrity stays yours",
    copy:
      "Canvascope is a study tool, not a way around your course rules. You are responsible for following your school and instructor academic-integrity policies.",
  },
  {
    icon: Bot,
    title: "The AI helps you study, it cannot submit your work",
    copy:
      "Canvascope AI creates study aids and answers grounded in your course context. It is built so it cannot submit graded work for you, and its output can be wrong, so verify before you rely on it.",
  },
  {
    icon: Lock,
      ...
      <section className="page-wrap max-w-4xl py-14 lg:py-20">
        <div className="space-y-6">
          ...
          <h1 className="text-5xl sm:text-6xl">
            What Canvascope does, what it does not, and what stays your responsibility.
          </h1>
          <p className="section-copy text-lg">
            These Terms of Service (the &ldquo;Terms&rdquo;) govern your use of
            Canvascope, Lectra Notes, and the Canvascope
            website and web workspace (together, the &ldquo;Service&rdquo;),
            operated by Canvascope Inc. By installing, signing in to, or using
        ...
        <div className="mt-14 space-y-12">
          <section className="space-y-4">
            ...
            <p className="section-copy">
              {
                "Canvascope is developed and operated by Canvascope Inc. These Terms apply to the Canvascope browser extension, the Canvascope website and web workspace, Lectra Notes distributed on the Apple App Store, and the connected workflows that share the same account system. Your privacy is covered separately by our "
              }
              <Link
                href="/privacy"
                className="font-semibold text-[var(--color-brand-deep)] underline underline-offset-4"
          ...
          <section className="space-y-4">
            ...
            <p className="section-copy">
              {
                "Some features require an account. You can sign in with Google or, on Lectra, with Sign in with Apple, using one shared identity across Canvascope, Lectra, and the web workspace. You are responsible for activity under your account and for keeping access to it secure. We may suspend or limit access to protect the Service, to respond to a security or account-risk signal (including Google Cross-Account Protection events), or to address a violation of these Terms. You can sign out at any time, and you can delete your account from within Lectra or by contacting us."
              }
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="section-copy">
              {
                "You keep ownership of the content you bring to the Service, including the PDFs and documents you index or send, clipboard signals and copied/pasted text, the highlights, ink, and notes you add in Lectra, the code and files in Lectra Projects, and the profile facts you save. You grant Canvascope Inc. a limited, non-exclusive, worldwide, royalty-free license to host, store, process, transmit, sync, and display that content solely to operate and support the Service for you, including delivering documents between your devices and generating the results you request."
              }
            </p>
            <p className="section-copy">
              {
          ...
          <section className="space-y-4">
            ...
            <p className="section-copy">
              {
                "Canvascope is a productivity and study tool. It does not replace your course rules, your instructors' instructions, or your institution's academic-integrity policies, and using Canvascope does not excuse a violation of them. You are solely responsible for ensuring that the way you use the Service, and any AI-assisted output you submit or rely on, complies with those policies."
              }
            </p>
            <p className="section-copy">
              {
                "Canvascope AI is designed to help you find, understand, plan, and practice, not to do graded work for you. The Canvascope agent can read your course context and create study aids such as to-dos, calendar events, and study plans, but it is built so that it cannot submit graded work on your behalf, and actions that resemble turning in a graded assignment are blocked. You remain responsible for confirming and meeting your own submission requirements and deadlines."
              }
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="section-copy">
              {
                "To the maximum extent permitted by law, Canvascope Inc. and its operators will not be liable for any indirect, incidental, special, consequential, or punitive damages, or for any loss of data, lost work, missed deadlines, or academic outcomes such as grades, arising out of or relating to your use of, or inability to use, the Service. Because the Service is provided free of charge, to the maximum extent permitted by law our total liability for any claim relating to the Service is limited to one hundred U.S. dollars (USD 100). Some jurisdictions do not allow certain limitations, so some of these limitations may not apply to you."
              }
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="section-copy">
              {
                "You agree to indemnify and hold harmless Canvascope Inc. from claims, damages, and expenses (including reasonable legal fees) arising out of your misuse of the Service, your violation of these Terms, or your violation of any law or the rights of a third party."
              }
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="section-copy">
              {
                "These Terms are governed by the laws of the United States and the state in which Canvascope Inc. is incorporated, without regard to conflict-of-laws principles, except where applicable consumer-protection law in your place of residence requires otherwise. Nothing in these Terms limits any non-waivable rights you have under the law of your jurisdiction."
              }
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="section-copy">
              {"Questions about these Terms can be sent to Canvascope Inc. at "}
              <a
                href={`mailto:${SUPPORT_EMAIL}`}
                className="font-semibold text-[var(--color-brand-deep)] underline underline-offset-4"
              >
