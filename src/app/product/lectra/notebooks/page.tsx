...
export const metadata: Metadata = {
  ...
  description,
  alternates: {
    canonical: "/product/lectra/notebooks",
  },
  keywords: [
      ...
      <JsonLd
        data={[
          breadcrumbSchema([
            ...
            { name: "Notebooks", path: "/product/lectra/notebooks" },
          ]),
          lectraFeaturePageSchema(
            "Lectra Notes — Jupyter Notebooks on iPad, Offline",
            "/product/lectra/notebooks",
            description,
          ),
          faqSchema(faqs),
          howToSchema(
        ...
        <div className="page-wrap split-section" style={{ paddingBlock: 0 }}>
          ...
          <div data-reveal>
            ...
            >
              ...
              <Link href="/product/lectra/code">the coding workspace</Link>;
              for handwritten work on paper styles, that&apos;s what{" "}
              <Link href="/product/lectra">the rest of Lectra Notes</Link> is
              for.
            </p>
          </div>
        </div>
