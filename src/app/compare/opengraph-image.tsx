...
export const alt =
  "Scope comparisons: honest comparisons, including where the other app wins";
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
          ...
          >
            Honest comparisons — including where the other app wins.
          </span>
          <span
            style={{
              fontSize: "30px",
          ...
          >
            Scope for Canvas and Lectra Notes next to the apps students already
            use, checked by hand with the trade-offs left in.
          </span>
        </div>
